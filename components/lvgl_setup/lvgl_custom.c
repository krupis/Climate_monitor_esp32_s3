...
void set_battery_voltage(float battery_voltage)
{
    ...
    lv_label_set_text(ui_BatLabel, final_temp_buf);
}
...
void ui_ConfirmationScreen_screen_init(void)
{
    ...
    lv_obj_add_event_cb(ui_UpdateProgress, ui_event_UpdateProgress, LV_EVENT_ALL, NULL);
...
static void set_update_progress_value(void *indic, int32_t v)
{
    ...
    lv_bar_set_value(ui_UpdateProgress, v, LV_ANIM_ON);
    if (v == 100)
    {
        printf("value reached 100 \n");
    }
}
...
void ui_event_UpdateProgress(lv_event_t *e)
{
    ...
    if (event_code == LV_EVENT_VALUE_CHANGED)
    {
        ...
        printf("value has been updated = %u \n", value);
    }
}
...
void ui_event_BackButton1(lv_event_t *e)
{
    ...
    if (event_code == LV_EVENT_CLICKED)
    {
        ...
        lv_bar_set_value(ui_UpdateProgress, 0, LV_ANIM_OFF);
    }
}
