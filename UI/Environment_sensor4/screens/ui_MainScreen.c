...
void ui_MainScreen_screen_init(void)
{
    ...
    lv_obj_set_width(ui_TemperatureGroup, 105);
    lv_obj_set_height(ui_TemperatureGroup, 160);
    lv_obj_set_x(ui_TemperatureGroup, -105);
    ...
    lv_obj_set_style_border_opa(ui_TemperatureGroup, 55, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_HumidityGroup, 105);
    ...
    lv_obj_set_style_border_opa(ui_HumidityGroup, 55, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_CO2Group, 105);
    lv_obj_set_height(ui_CO2Group, 160);
    lv_obj_set_x(ui_CO2Group, 105);
    ...
    lv_obj_set_style_border_opa(ui_CO2Group, 55, LV_PART_MAIN | LV_STATE_DEFAULT);
